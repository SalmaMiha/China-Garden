...
class Prawn extends StatefulWidget {
  const Prawn({Key? key}) : super(key: key);

  @override
  _PrawnState createState() => _PrawnState();
}

class _PrawnState extends State<Prawn> {
  ...
  fetchProducts() async{
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("Prawn").get();
    setState(() {

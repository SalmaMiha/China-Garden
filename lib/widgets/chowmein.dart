...
class Chow_Mein extends StatefulWidget {
  const Chow_Mein({Key? key}) : super(key: key);

  @override
  _Chow_MeinState createState() => _Chow_MeinState();
}

class _Chow_MeinState extends State<Chow_Mein> {
  ...
  fetchProducts() async{
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("Chow Mein").get();
    setState(() {

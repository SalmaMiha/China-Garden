...
class Khichuri_Biriyani extends StatefulWidget {
  const Khichuri_Biriyani({Key? key}) : super(key: key);

  @override
  _Khichuri_BiriyaniState createState() => _Khichuri_BiriyaniState();
}

class _Khichuri_BiriyaniState extends State<Khichuri_Biriyani> {
  ...
  fetchProducts() async{
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("Khichuri & Biriyani").get();
    setState(() {

...
class Fried_Rice extends StatefulWidget {
  const Fried_Rice({Key? key}) : super(key: key);

  @override
  _Fried_RiceState createState() => _Fried_RiceState();
}

class _Fried_RiceState extends State<Fried_Rice> {
  ...
  fetchProducts() async{
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("Fried Rice").get();
    setState(() {

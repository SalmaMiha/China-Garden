...
class Sizzling extends StatefulWidget {
  const Sizzling({Key? key}) : super(key: key);

  @override
  _SizzlingState createState() => _SizzlingState();
}

class _SizzlingState extends State<Sizzling> {
  ...
  fetchProducts() async{
    ...
    QuerySnapshot qn =
    await _firestoreInstance.collection("Sizzling").get();
    setState(() {
